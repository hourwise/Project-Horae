...
| Capability matching           | Horae                                           | Build capability plans from healthy registrations and requested capabilities | Expose every installed capability by default                 | Implemented and tested                                                  |
| Compatibility negotiation     | Horae                                           | Carry `protocolVersion` in runtime identities and plan for negotiation       | Claim compatibility checks that are not implemented          | Designed                                                                |
| Composition planning          | Horae                                           | Create `HoraeCapabilityPlan` and `HoraeSession` scaffolds                    | Treat a session scaffold as governed execution               | Implemented and tested at scaffold level                                |
